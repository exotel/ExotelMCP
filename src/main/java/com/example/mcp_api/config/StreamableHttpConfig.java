...
public class StreamableHttpConfig {
    ...
    @Autowired
    private com.example.mcp_api.service.VoiceBotService voiceBotService;

    @Autowired
    private com.example.mcp_api.service.VoiceBotAdminTools voiceBotAdminTools;
    ...
    @Autowired
    private com.example.mcp_api.service.AiAssistService aiAssistService;
    ...
    private Map<String, Object> createToolsListResponse(Object id) {
        ...
        Object[] services = {exotelService, quickAudioService, cqaService, voiceBotService, voiceBotAdminTools, setupTools, voiceBotToolsService, engageService, aiAssistService};
